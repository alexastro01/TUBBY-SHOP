  ...
  */
  ...
  const askContractToMintNft = async () => {
    ...
    try {
      ...
      if (ethereum) {
        ...
        let nftTxn = await connectedContract.mint(accounts[0], 3, 1 , 32, { value: utils.parseEther('0.009'), gasLimit: 50000 } );
  ...
  return (
    <div className='bg-gray-700 pt-7 h-[700px] '>
      ...
      <img src={blueT} className='h-[400px] w-[400px] m-auto sm:mr-32  sm:h-[600px] sm:w-[600px]  bg-gray-700 sm:float-left rounded-xl   sm:ml-32 hover:scale-110 transition-transform  ' alt='./'/>
