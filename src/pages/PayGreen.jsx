  ...
  */
  ...
  return (
    <div className='bg-gray-700 pt-7 h-[700px] '>
      ...
      <img src={greenT} className='h-[400px] w-[400px] m-auto sm:mr-32  sm:h-[600px] sm:w-[600px]  bg-gray-700 sm:float-left rounded-xl   sm:ml-32 hover:scale-110 transition-transform  ' alt='./'/>
